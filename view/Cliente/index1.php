...
<head>
  ...
  <link red="stylesheet" href="../../assets/css/menu.css" type="text/css"> 
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand font-italic text-warning" href="#">DREAM STORE</a>
    ...
    <div class="collapse navbar-collapse aling-left ml-5 pl-2" id="navbarNav">
      <ul class="navbar-nav text-center">
        <li class="nav-item active pl-2">
          <svg class="bi bi-alert-triangle text-warning" width="32" height="32" viewBox="0 0 16 16" class="bi bi-cart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
          </svg>
          <a class="nav-link" href="#">Agregar al carro</a>
        </li>
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-warning" width="32" height="32" viewBox="0 0 16 16" class="bi bi-bell-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z" />
          </svg>
          <a class="nav-link" href="#">Notificacion</a>
        </li>
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-warning" width="32" height="32" viewBox="0 0 16 16" class="bi bi-arrow-down-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-warning" width="32" height="32" viewBox="0 0 16 16" class="bi bi-chat-quote-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-warning" width="32" height="32" viewBox="0 0 16 16" class="bi bi-basket3-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-warning" width="32" height="32" viewBox="0 0 16 16" class="bi bi-stopwatch-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-warning" width="32" height="32" viewBox="0 0 16 16" class="bi bi-question-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.496 6.033a.237.237 0 0 1-.24-.247C5.35 4.091 6.737 3.5 8.005 3.5c1.396 0 2.672.73 2.672 2.24 0 1.08-.635 1.594-1.244 2.057-.737.559-1.01.768-1.01 1.486v.105a.25.25 0 0 1-.25.25h-.81a.25.25 0 0 1-.25-.246l-.004-.217c-.038-.927.495-1.498 1.168-1.987.59-.444.965-.736.965-1.371 0-.825-.628-1.168-1.314-1.168-.803 0-1.253.478-1.342 1.134-.018.137-.128.25-.266.25h-.825zm2.325 6.443c-.584 0-1.009-.394-1.009-.927 0-.552.425-.94 1.01-.94.609 0 1.028.388 1.028.94 0 .533-.42.927-1.029.927z" />
          </svg>
          <a class="nav-link" href="#">Ayuda</a>
        </li>
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-warning" width="32" height="32" viewBox="0 0 16 16" class="bi bi-person-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
