...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-dark" id="may">
    <a class="navbar-brand font-italic text-white" href="#">DREAM STORE</a>
    ...
    <div class="collapse navbar-collapse aling-left ml-5 pl-2 " id="navbarNav">
      <ul class="navbar-nav text-center">
        <li class="nav-item active pl-2">
          <svg class="bi bi-alert-triangle text-white" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
          </svg>
          <a class="nav-link text-white" href="#">Agregar al carro</a>
        </li>
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-white" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-bell-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z" />
          </svg>
          <a class="nav-link text-white" href="#">Notificacion</a>
        </li>
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-white" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-down-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-white" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chat-quote-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-white" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-basket3-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-white" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-stopwatch-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-white" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-question-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="nav-item active pl-3">
          <svg class="bi bi-alert-triangle text-white" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-person-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="container">
    ...
    <div class="float-righ w-95 -95">
      ...
      <div class="container">
        ...
        <div class="row mx-md-n5" id="ofertas">
          <div class="col px-md-7">
            <div class="p-3 border bg-dark">
              <div class="min-vw-25">
                <h6 class="text-center">Televisor Lenovo</h6><img src="<?= base_url ?>assets/img/cliente/producto1.jpg" alt="..." class="img-thumbnail">
                <h6 class="text-left">precio: 1.200.000</h6><button type="button" class="btn btn-success">Agregar</button>
              </div>
            </div>
          </div>
          <div class="col px-md-7">
            <div class="p-3 border bg-dark">
              <div class="min-vw-25">
                <h6 class="text-center">PS 5</h6><img src="<?= base_url ?>assets/img/cliente/producto2.jpg" alt="..." class="img-thumbnail">
                <h6 class="text-left">precio: 3.200.000</h6><button type="button" class="btn btn-success">Agregar</button>
              </div>
            </div>
          </div>
          <div class="col px-md-7">
          ...
          <div class="container">
            <p class=" h2 text-center font-weight-bolder text-white pl-3 my-3 py-3 ">Mas Vendidos</p>
            <div class="row mx-md-n5" id="ofertas">
              <div class="col px-md-7">
                <div class="p-3 border bg-dark">
                  <div class="min-vw-25">
              ...
              <div class="container">
                <p class=" h2 text-center font-weight-bolder text-white pl-3 my-3 py-3 ">Mis Favoritos</p>
                <div class="row mx-md-n5" id="ofertas">
                  <div class="col px-md-7">
                    <div class="p-3 border bg-dark">
                      <div class="min-vw-25">
