...
<main role="main" class="col-md-9 ml-sm-auto  col-lg-10 px-md-4">
    ...
    <div class="container-sm w-75">
        <div class="float-left w-50 px-4">
            <table class="table table-sm table-borderless w-100  bg-white shadow">
                <tr>
                    ...
                    <td colspan="2"><span class="h6">Usuarios eliminados este mes</span></td>
                </tr>
        ...
        <div class="float-right w-50 px-5 ">
            <table class="table table-sm table-borderless w-100  bg-white shadow">
                <tr>
                    ...
                    <td colspan="2" class="text-left"><span class="h6">Usuarios nuevos este mes</span></td>
                </tr>
                <tr class=" border-top  w-75">
                    <td class="w-25">
