...
<div class="container text-center">
    ...
    <div class="float-right">
        ...
        <a href="<?=base_url?>Principal/BorrarTodos" class="btn text-white bg-danger">Eliminar todos</a>
    </div>
                            ...
                            <div class="card mb-4 shadow-sm ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="<?=base_url?>Principal/BorrarUno?id=<?=$contador?>" class="btn btn-sm btn-outline-danger">Eliminar</a>
                                        </div>
