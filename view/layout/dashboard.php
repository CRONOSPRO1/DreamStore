    ...
    <nav class="navbar navbar-dark sticky-top bg-dark w-100 flex-md-nowrap p-0 shadow" >
        ...
        <ul class="navbar-nav navbar-expand-lg px-5  text-right ">
            ...
            <div class="mr-auto p-3 text-center">
                ...
                <a href="#" class="text-right  " id="notificacionesclick">
                    <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-bell text-warning" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="mr-auto p-2 text-center">
                <span class="mr-4" id="span-margen"></span>
                <a href="#" class="text-light" id="perfil">
                    <svg width="2.7em" height="2.7em" viewBox="0 0 16 16" class="bi bi-person-circle " fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark   sidebar collapse">
                <div class="sidebar-sticky pt-3 ">
                    <ul class="nav flex-column mt-2">
                        ...
                        <li class="nav-item  ">
                            <a class="nav-link active" href="../administrador/Productos.php">
                                <span>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../administrador/ventas.php">
                                <span>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../administrador/Compras.php">
                                <span>
