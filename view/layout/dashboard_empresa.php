...
<body>
    ...
    <nav class="navbar navbar-dark sticky-top bg-dark w-100 flex-md-nowrap p-0 shadow">
        ...
        <ul class="navbar-nav navbar-expand-lg px-4 inline-block text-right ">
            <li class="nav-item px-3">
                <a class="nav-link mt-1 text-light" href="#"> <span>
            ...
            <li class="nav-item px-3">
                <a class="nav-link text-light" href="#"> <span>
                        <svg width="2.6em" height="2.6em" viewBox="0 0 16 16" class="bi bi-person-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark   sidebar collapse">
                <div class="sidebar-sticky pt-3 ">
                    <ul class="nav flex-column mt-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <span data-feather="layers"></span> Editar sitio
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <span data-feather="layers"></span> Config
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="../administrador/quejas.php">
                                <span data-feather="file"></span> Sugerencias
                            </a>
                        </li>
                    </ul>
