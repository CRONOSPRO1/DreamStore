...
<head>
    ...
    <link href="../../assets/css/dashboard_empresa.css" rel="stylesheet">
</head>
<script>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark   sidebar collapse">
                <div class="sidebar-sticky pt-3 ">
                    <ul class="nav flex-column mt-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../Empresa/usuarios_Registrados.php">
                                <span data-feather="users"></span> usuarios Registrados
                            </a>
                        </li>

                        <li class="nav-item  ">
                            <a class="nav-link active" href="../Empresa/Productos_Empresa.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../Empresa/Ventas_Empresa.php">
                                <span>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../Empresa/Recibo_Compras.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../Empresa/Agenda_Empresas.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../Empresa/Editar_Usuarios.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../Empresa/Editar_Proveedores.php">
                                <span data-feather="Pencil square">
                    ...
                    <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-light">
                        ...
                        <a class="d-flex align-items-center text-light" href="../Empresa/Reportes.php" aria-label="Add a new report">
